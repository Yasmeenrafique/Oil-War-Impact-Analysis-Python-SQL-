...
if st.button(" Insights "):
    ...
    # -------------------------------
    # 7️⃣ Exposure Score Chart
    # -------------------------------
    st.subheader("⚠️ Top Countries by Exposure Score")
    ...
    # -------------------------------
    # 8️⃣ Scatter: Oil Import vs Petrol Price Increase
    # -------------------------------
    ...
    # -------------------------------
    # 9️⃣ Additional Chart 1: Petrol Price Increase
    # -------------------------------
    ...
    # -------------------------------
    # 10️⃣ Additional Chart 2: Oil Import Dependency
    # -------------------------------
    st.subheader("🛢️ Country Oil Import Dependency")
